![Foodgram](https://github.com/darkteman/foodgram-project-react/actions/workflows/main.yml/badge.svg)
...
### Адрес сервера: http://51.250.66.232/

### Данные администратора для проверку функциональности
Почта: ```admin@ya.ru```
Логин: ```admin```
Пароль: ```23Admin```
